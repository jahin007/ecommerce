        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="aside" class="col-md-3">
                    <!-- aside Widget -->
                    <div class="aside">
                        <h3 class="aside-title" style="color: #D10024;">SubCategories</h3>
                        <div class="checkbox-filter">
                            @foreach($subcategories as $subcategory)
                                @php
                                $subProduct_count =App\Models\Product::subProduct_count($subcategory->id);
                                @endphp
                            <div class="input-checkbox">
                                <label for="category-1">
                                    <span></span>
                                        <li><a href="{{route('product_by_subcat',$subcategory->id)}}">{{$subcategory->name}}<small>  ({{$subProduct_count}})</small></a></li>
                                </label>
                            </div>
                            @endforeach
                        </div>
                ...
                <div id="store" class="col-md-9">
                    ...
                    <div class="store-filter clearfix">
                        ...
                        <ul class="store-grid">
                            <li class="active"><i class="fa fa-th" style="padding-top: 10px;"></i></li>
                            <li><a href="#"><i class="fa fa-th-list" style="padding-top: 10px;"></i></a></li>
                        </ul>
                    </div>
                    <!-- /store top filter -->
